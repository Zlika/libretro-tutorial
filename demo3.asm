...
LD R1,$0x1F50
; Réinitilisation de l'état du clavier pour éviter les répétitions
LD R2,0
ST R2,$0x1F50
...
BRA .gestion_couleur
; Flèche vers le haut enfoncée : init_video_pos-=80colonnes*2octets
.kb_up
ADD R2,-160
ST R2,.init_video_pos
BRA .gestion_couleur
; Flèche vers le bas enfoncée : init_video_pos+=80colonnes*2octets
.kb_down
ADD R2,160
ST R2,.init_video_pos
BRA .gestion_couleur
; Flèche vers la droite enfoncée : init_video_pos+=2octets
.kb_right
ADD R2,2
ST R2,.init_video_pos
BRA .gestion_couleur
; Flèche vers la gauche enfoncée : init_video_pos-=2octets
.kb_left
ADD R2,-2
ST R2,.init_video_pos
